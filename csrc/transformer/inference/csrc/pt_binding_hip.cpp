...
#include <stdexcept>
#include <vector>
#include "inference_context_hip.h"
#include "inference_cublas_wrappers_hip.h"
#include "inference_hip_layers.h"
                       ...
                       int window_size)
{
    ...
    rocblas_set_stream(InferenceContext::Instance().GetCublasHandle(),
                              ...
                              bool transposed_mode)
{
    ...
    if (q_int8) {
        ...
        rocblas_set_stream(InferenceContext::Instance().GetCublasHandle(),
                        InferenceContext::Instance().GetCurrentStream());
        cublas_gemm_ex(InferenceContext::Instance().GetCublasHandle(),
                       (transposed_mode ? rocblas_operation_transpose : rocblas_operation_none),
                       rocblas_operation_none,
                           ...
                           bool transposed_mode)
{
    ...
    // hipEventRecord(InferenceContext::Instance().GetCompEvent(2),
