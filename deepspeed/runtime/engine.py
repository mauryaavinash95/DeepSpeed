...
class DeepSpeedEngine(Module):
    ...
    def _configure_checkpointing(self, dist_init_required):
        ...
        if self._config is not None and self._config.veloc_config:
            ...
            self.checkpoint_engine = VELOCCheckpointEngine({"rank": rank, "local_rank": self.local_rank, "device": torch.cuda.current_device(), "veloc_config": self._config.veloc_config})
